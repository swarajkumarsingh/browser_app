...
final tabsListProvider = StateProvider<List<WebViewModel>>((ref) => <WebViewModel>[WebViewModel(url: "https://google.com/", tabIndex: 1, title: "Google", isIncognitoMode: false, screenshot: webviewDB.getHomeScreenImageBytes()), WebViewModel(url: "https://youtube.com/", tabIndex: 1, title: "Google", isIncognitoMode: false, screenshot: webviewDB.getHomeScreenImageBytes())]);